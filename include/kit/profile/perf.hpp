...
#define KIT_PERF_SCOPE(name) kit::timer tm##__LINE__(name);
#define KIT_PERF_FUNCTION() kit::timer tm##__LINE__(__FUNCTION__);
#ifdef __PRETTY_FUNCTION__
#define KIT_PERF_PRETTY_FUNCTION() kit::timer tm##__LINE__(__PRETTY_FUNCTION__);
#else
