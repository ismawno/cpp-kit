...
namespace kit
{
template <std::floating_point Float> transform2D<Float> transform2D<Float>::s_transform{};

template <std::floating_point Float> transform2D<Float>::builder::builder(const transform2D &transform)
{
    s_transform = transform;
}
template <std::floating_point Float> transform2D<Float>::builder::builder()
{
    s_transform = {};
}
...
template <std::floating_point Float> transform2D<Float> transform2D<Float>::builder::build() const
{
    return s_transform;
}
...
template <std::floating_point Float> void transform2D<Float>::ltranslate(const vec2 &dpos)
{
...
template <std::floating_point Float> void transform2D<Float>::lxtranslate(const Float dx)
{
    const auto [c, s] = trigonometric_functions(rotation);
    position += vec2(c * dx, s * dx);
}
template <std::floating_point Float> void transform2D<Float>::lytranslate(const Float dy)
{
    const auto [c, s] = trigonometric_functions(rotation);
...
template <std::floating_point Float> transform3D<Float> transform3D<Float>::s_transform{};

template <std::floating_point Float> transform3D<Float>::builder::builder(const transform3D &transform)
{
    s_transform = transform;
}
template <std::floating_point Float> transform3D<Float>::builder::builder()
{
    s_transform = {};
}
template <std::floating_point Float>
...
template <std::floating_point Float> transform3D<Float> transform3D<Float>::builder::build() const
{
    return s_transform;
}
...
template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::inverse_rotation() const
{
    return glm::transpose(rotation);
}

template <std::floating_point Float> void transform3D<Float>::ltranslate(const vec3 &dpos)
{
    position += rotation * dpos;
}
template <std::floating_point Float> void transform3D<Float>::lxtranslate(Float dx)
{
    position += rotation[0] * dx;
}
template <std::floating_point Float> void transform3D<Float>::lytranslate(Float dy)
{
    position += rotation[1] * dy;
}
template <std::floating_point Float> void transform3D<Float>::lztranslate(Float dz)
{
    position += rotation[2] * dz;
}

template <std::floating_point Float> void transform3D<Float>::lrotate(const mat3 &rotmat)
{
    rotation *= rotmat;
}
template <std::floating_point Float> void transform3D<Float>::grotate(const mat3 &rotmat)
{
...
template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::XZY(const vec3 &rotation)
{
...
template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::YXZ(const vec3 &rotation)
{
...
template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::YZX(const vec3 &rotation)
{
...
template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::ZXY(const vec3 &rotation)
{
...
template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::ZYX(const vec3 &rotation)
{
...
template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::YZ(Float roty, Float rotz)
{
    const auto [c2, s2] = transform2D<Float>::trigonometric_functions(roty);
    const auto [c3, s3] = transform2D<Float>::trigonometric_functions(rotz);
...
template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::ZY(Float rotz, Float roty)
{
    const auto [c2, s2] = transform2D<Float>::trigonometric_functions(roty);
    const auto [c3, s3] = transform2D<Float>::trigonometric_functions(rotz);
...
template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::X(const Float rotx)
{
    const auto [c, s] = transform2D<Float>::trigonometric_functions(rotx);
    return {{1.f, 0.f, 0.f}, {0.f, c, s}, {0.f, -s, c}};
}

template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::Y(const Float roty)
{
    const auto [c, s] = transform2D<Float>::trigonometric_functions(roty);
    return {{c, 0.f, -s}, {0.f, 1.f, 0.f}, {s, 0.f, c}};
}

template <std::floating_point Float> typename transform3D<Float>::mat3 transform3D<Float>::Z(const Float rotz)
{
